...
alias docker-deploy='sudo docker-compose up --build -d' # No production yml yet.
alias docker-test='docker-compose -f docker-compose.yml -f docker-compose-test.yml up --build --abort-on-container-exit'
