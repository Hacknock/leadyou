...
alias docker-deploy='sudo docker-compose -f docker-compose.yml -f production.yml up --build -d'
alias docker-test='sudo docker-compose -f docker-compose.yml -f test.yml up --build --abort-on-container-exit'
